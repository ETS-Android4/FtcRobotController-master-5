...
@Autonomous(name="Autonomys Engine V1 Change Z Blue 1 New", group="Blue")
//@Disabled
public class Autonomys_Engine_V1_Change_Z_Blue1_New extends LinearOpMode {

    /* Declare OpMode members. */
    HardwarePushbotV3 robot   = new HardwarePushbotV3();   // Use a Pushbot's hardware
    private final ElapsedTime     runtime = new ElapsedTime();

    static final double     r1 = 0.2;
    static final double     r2 = 1.6;
