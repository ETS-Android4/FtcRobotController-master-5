...
@Autonomous(name="If Robot can not move Autonomys Engine V1 Change Z Blue 1 New", group="Blue")
//@Disabled
public class Autonomys_Engine_V1_Change_Z_Blue1_New2 extends LinearOpMode {
    ...
    static final double     r2 = .9;
    static final double     r3 = 4.5;
    static final double     r4 = 1.9;
